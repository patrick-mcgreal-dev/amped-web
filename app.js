(() => {
  ...
  var Essential_Audio = (() => {
    ...
    var ie = f;
    try {
      var ig = Object.defineProperty({}, "passive", { get: () => {
        ie = t;
      } });
    ...
    function L(a) {
      V(a);
      var vg = 0;
      for (var i2 = 0; i2 < pn(a).length; i2++) {
        if (pn(a).start(pn(a).length - 1 - i2) <= pm(a)) {
          vg = pn(a).end(pn(a).length - 1 - i2);
          break;
        }
      }
      if (vg >= pm(a)) {
    ...
    function U(a) {
      if (pl(a)) {
        ...
        var vi = 0;
        for (var i2 = 0; i2 < pn(a).length; i2++) {
          if (pn(a).start(pn(a).length - 1 - i2) <= vh) {
            vi = pn(a).end(pn(a).length - 1 - i2);
            break;
          }
        }
        a.zg = pp(vi / pl(a) * 100);
    ...
    return { init: Be, Audio: A, Play: N, Stop: R, Reset: S, players: Xa, active: Xb, last: Xc };
    function Xa() {
      return b;
    }
    function Xb() {
